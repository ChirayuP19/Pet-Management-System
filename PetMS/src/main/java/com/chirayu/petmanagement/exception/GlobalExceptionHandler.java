...
import com.chirayu.petmanagement.dto.ErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DuplicatePetFoundException.class)
    public ResponseEntity<ErrorDTO> handleDuplicatePetFoundException(DuplicatePetFoundException e) {
        log.error("DuplicatePetFoundException: {}", e.getMessage());
        ErrorDTO errorDTO = new ErrorDTO(e.getMessage(),HttpStatus.CONFLICT,HttpStatus.CONFLICT.value(),LocalDateTime.now());
